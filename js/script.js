...
const translations = {
  nl: {
    ...
    'wedding.cake.time': 'Na de ceremonie', 'wedding.cake.desc': "Taart, gelukwensen & foto's",
    'wedding.drinks.time': 'Vanaf het taartmoment', 'wedding.drinks.desc': 'Onbeperkt bier, wijn & frisdrank',
    'wedding.drinks.note': 'Drankjes zijn beschikbaar vanaf dit moment.',
    'wedding.dinner.time': '[DINER TIJDSTIP TOEVOEGEN]', 'wedding.dinner.desc': 'Diner',
    'wedding.speeches.time': '[TIJDSTIP TOESPRAKEN TOEVOEGEN]', 'wedding.speeches.desc': 'Toespraken & avondfeest',
    'wedding.party.time': '[TIJDSTIP FEEST TOEVOEGEN]', 'wedding.party.desc': 'Feest',
    'wedding.note': 'Definitieve tijden en details worden nader gecommuniceerd.',
    // Location
    'location.label': 'Locatie', 'location.h2': 'Hier naartoe',
    'location.travel.h': 'Reizen', 'location.parking.h': 'Parkeren',
    'location.accom.h': 'Overnachting', 'location.taxi.h': 'Taxi & vervoer',
    ...
    'rsvp.deadline': 'Reageer voor:', 'rsvp.btn': 'Open RSVP-formulier',
  ...
  en: {
    ...
    'wedding.cake.time': 'After ceremony', 'wedding.cake.desc': 'Cake, Congratulations & Photos',
    'wedding.drinks.time': 'From the cake moment', 'wedding.drinks.desc': 'Unlimited Beer, Wine & Soft Drinks',
    'wedding.drinks.note': 'Drinks are available from this point onward.',
    'wedding.dinner.time': '[ADD DINNER TIME]', 'wedding.dinner.desc': 'Dinner',
    'wedding.speeches.time': '[ADD SPEECH TIME]', 'wedding.speeches.desc': 'Speeches & Evening Celebration',
    'wedding.party.time': '[ADD PARTY TIME]', 'wedding.party.desc': 'Party',
    'wedding.note': 'Final timings and details will be updated closer to the wedding.',
    'location.label': 'Venue', 'location.h2': 'Getting There',
    'location.travel.h': 'Travel', 'location.parking.h': 'Parking',
    'location.accom.h': 'Accommodation', 'location.taxi.h': 'Taxi & Transport',
    ...
    'rsvp.deadline': 'Please respond before:', 'rsvp.btn': 'Open RSVP Form',
